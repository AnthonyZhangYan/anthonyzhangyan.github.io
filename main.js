...
function linkClass(name, url) {
  ...
  if (lowerName.includes('icml') || lowerUrl.includes('icml.cc')) return 'icml-link';
  if (lowerName.includes('openreview') || lowerUrl.includes('openreview.net')) return 'openreview-link';
